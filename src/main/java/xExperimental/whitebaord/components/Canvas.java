...
import xExperimental.whitebaord.properties.PropertiesListener;

/**
 * Canvas2 allows a user to add various shapes to a Pane.
 * 
 */
public class Canvas extends Pane implements PropertiesListener {
    ...
    /**
     * Set the background color of this Canvas2.
     */
    ...
    /**
     * Add an eraser Shape to this Canvas2.
     * 
    ...
    /**
     * Get the X distance this Canvas2 is from the origin
     */
    ...
    /**
     * Get the Y distance this Canvas2 is from the origin
     */
    ...
    /**
     * Set the X and Y distance this Canvas2 is from the origin.
     * 
