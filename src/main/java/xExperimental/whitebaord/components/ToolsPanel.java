...
import xExperimental.whitebaord.tools.ColorPicker;
import xExperimental.whitebaord.tools.Eraser;
import xExperimental.whitebaord.tools.Pen;
import xExperimental.whitebaord.tools.Tool;
...
public class ToolsPanel extends HBox {
    ...
    public static String PEN_ICON = "/pen.png";
    public static String ERASER_ICON = "/eraser.png";
    public static String COLOR_PICKER_ICON = "/color-picker.png";
