...
/**
 * Use Tools to draw/edit/do whatever on a Canvas2.
 * 
 * This class should be extended to create new xExperimental.whitebaord.tools.
 */
public class Tool implements EventHandler<MouseEvent> {
    ...
    /**
     * Create a fake Tool. This tool will hold the real tool and should be the only tool used on a Canvas2.
     */
    public Tool() {}
    ...
    /**
     * Get the Canvas2 this tool is editing.
     */
    ...
    /**
     * Handle mouse events on the Canvas2.
     * 
