...
public class ZoomAndPanExample extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scrollPane.addEventFilter( ScrollEvent.ANY, sceneGestures.onScrollEventHandler);
//        scrollPane.addEventFilter( ZoomEvent.ZOOM_STARTED , sceneGestures.onZoomEventHandler);
    ...
    public class SceneGestures {
        ...
        public EventHandler<ScrollEvent> onScrollEventHandler = new EventHandler<ScrollEvent>() {
            ...
            public void handle(ScrollEvent event) {
                ...
                double oldScale = panAndZoomPane.getScale();;
         ...
         * Mouse wheel handler: zoom to pivot point
         */
        public EventHandler<ZoomEvent> onZoomEventHandler = new EventHandler<ZoomEvent>() {
            ...
            public void handle(ZoomEvent event) {
                ...
                panAndZoomPane.setDeltaY(event.getY());
                if (panAndZoomPane.deltaY.get() < 0) {
                    scale /= delta;
                } else {
                    scale *= delta;
