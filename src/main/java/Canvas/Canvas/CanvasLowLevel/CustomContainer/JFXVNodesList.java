...
public class JFXVNodesList extends VBox {
     ...
     */
    public JFXVNodesList(double spacing) {
        this.setPickOnBounds(false);
        this.getStyleClass().add("jfx-nodes-list");
        this.setSpacing(spacing);
    }

    public JFXVNodesList addBtns(JFXButton... buttons) {
    ...
    public void animateList() {
        ...
        if (animateTimeline.getStatus() == Animation.Status.RUNNING) {
